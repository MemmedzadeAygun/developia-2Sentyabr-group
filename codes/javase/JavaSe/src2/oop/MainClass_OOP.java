...
public class MainClass_OOP {
	public static void main(String[] args) {
		/*DigitalPayment card=new CardPayment();
		card.processPayment(1200);
		System.out.println(card.getPaymentType());
		card.verifyTransaction();
		
		DigitalPayment digital=new MobilePayment();
		digital.processPayment(2000);
		System.out.println(digital.getPaymentType());
		digital.verifyTransaction();*/
